...
use FondOfSpryker\Zed\JellyfishThirtyFiveUp\Communication\JellyfishThirtyFiveUpCommunicationFactory;
...
{
    /**
     * @var \FondOfSpryker\Zed\JellyfishThirtyFiveUp\Communication\Plugin\JellyfishThirtyFiveUpOrderExpanderPlugin
     */
    protected $plugin;
    ...
    /**
     * @var \FondOfSpryker\Zed\JellyfishThirtyFiveUp\Communication\JellyfishThirtyFiveUpCommunicationFactory|\PHPUnit\Framework\MockObject\MockObject
     */
    ...
    protected function _before(): void
    {
        ...
        $this->plugin = new class ($this->factoryMock) extends JellyfishThirtyFiveUpOrderExpanderPlugin {
             ...
             *  constructor.
             *
             * @param \FondOfSpryker\Zed\JellyfishThirtyFiveUp\Communication\JellyfishThirtyFiveUpCommunicationFactory $factory
             */
